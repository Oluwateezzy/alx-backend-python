...
def safely_get_value(dct: Mapping, key: Any, default: Union[T, None] = None) -> Union[Any, T]:
    ...
    Args:
        dct (Mapping): A mapping (e.g., dictionary) with keys and values.
    ...
    Returns:
        Union[Any, T]: The value associated with the key in the mapping, or the default value if the key is not found.
    """
    if key in dct:
        return dct[key]
    else:
